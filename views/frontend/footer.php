<section class="hdl-footer pb-4">
      <div class="container">
         <div class="row">
            <div class="col-md-4 pt-4">
               ...
               <p class="pt-1">
                  Copyright@ 2024 HaiDuongShop là hệ thống bán sĩ và lẽ thời trang nam, nữ, trẻ em và quần áo thể thao,
                  mong muốn đem đến chất lượng tốt nhất cho khách hàng.
               </p>
               <p class="pt-1">
                  Địa chỉ: 055, Khóm Kinh Ven, Phường Khánh Hòa, Thị Xã Vĩnh Châu, Sóc Trăng
               </p>
               <p class="pt-1">
                  Điện thoại: 0981992900(call, zalo) - Email: dayduongtui@gmail.com
               </p>
            ...
            <div class="col-md-4 pt-4 text-end">
               ...
               <p class="my-1">9999999999 lượt</p>
            </div>
         </div>
      </div>
   </section>
   <section class="dhl-copyright bg-dark py-3">
      <div class="container text-center text-white">
         Thiết kế bởi: Bùi Hải Dương - Phone: 0981992900
      </div>
   </section>
</body>
